...
export const DUMMY_POSTS: BlogPost[] = [
    {
        ...
        author: { id: '1', name: 'Jane Doe', avatar: PlaceHolderImages.find(p => p.id === 'author-1')!, bio: 'An expert in financial regulations and tax law with over 10 years of experience.' },
