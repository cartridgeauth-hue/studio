...
const DUMMY_POSTS = [
    { id: '1', title: 'Navigating the Labyrinth of GST', publishedAt: '2024-05-20' },
    { id: '2', title: 'The Future of Digital Stamping', publishedAt: '2024-05-18' },
    { id: '3', title: 'Maximizing Your EPF Returns', publishedAt: '2024-05-15' },
];
                ...
                <CardContent className="flex flex-col md:flex-row items-start gap-8">
                    <div className="flex flex-col items-center gap-4">
                        <Avatar className="w-24 h-24">
                            <AvatarImage src={DUMMY_AUTHOR.avatar.imageUrl} alt={DUMMY_AUTHOR.name} data-ai-hint={DUMMY_AUTHOR.avatar.imageHint} />
